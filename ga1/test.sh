...
./spiral "input=input11.txt;output=output11.txt" 1>1.stdcout 2>1.stderr
...
# For test case 2
./spiral "input=input12.txt;output=output12.txt" 1>1.stdcout 2>1.stderr
...
# For test case 3
./spiral "input=input13.txt;output=output13.txt" 1>1.stdcout 2>1.stderr

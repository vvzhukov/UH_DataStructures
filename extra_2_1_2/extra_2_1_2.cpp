...
void benchmark(int n=0){
    ...
    int* array2 = generate_array(n);
    int* array3 = generate_array(n);
    int* array4 = generate_array(n);
    int* array5 = generate_array(n);
    ...
    (CLOCKS_PER_SEC / 1000) << " ms." << " Total swaps: " << steps << std::endl;
    
    clock_t    start2;
    start2 = clock();
    int steps2 = insertionSort(array2, n);
    // your test
    std::cout << "Time insert, "<<n<<" entries: " << (std::clock() - start2) / (double)(CLOCKS_PER_SEC / 1000) << " ms." << " Total swaps: " << steps2 << std::endl;
    
    clock_t    start3;
    start3 = clock();
    int steps3 = selectionSort(array3, n);
    // your test
    std::cout << "Time select, "<<n<<" entries: " << (std::clock() - start3) / (double)(CLOCKS_PER_SEC / 1000) << " ms."<< " Total swaps: " << steps3 << std::endl;
    
    clock_t    start4;
    start4 = clock();
    int steps4 = mergeSort(array4,0, n-1);
    // your test
    std::cout << "Time merge, "<<n<<" entries: " << (std::clock() - start4) / (double)
    (CLOCKS_PER_SEC / 1000) << " ms." << " Total swaps: " << steps4 << std::endl;

    ...
    int book_search(string keyword, string value) { // search for node, return position
        ...
        while (temp != nullptr) { // linear search
            ...
            if (keyword == "book_id") {
                ...
                if (temp -> book_name == value)
                    return i;
            } else if (keyword == "book_author") {
                if (temp -> book_author == value)
                    return i;
            };
            i++;
            temp = temp -> next;
...
int main (int argc, char** argv) {
    ...
    //string A = "/Users/apple/Desktop/6306_Data_Structures_DrRizk/hw2/input23.txt";
    //string B = "/Users/apple/Desktop/6306_Data_Structures_DrRizk/hw2/command23.txt";
    //string C = "/Users/apple/Desktop/6306_Data_Structures_DrRizk/hw2/tmp23.txt";
    ...
    if (ifile1.is_open())
    {
        while ( getline (ifile1, line) ) //go through each line
        {
            if (line.length() != 0) {
                ...
                string arg21 = line.substr(line.find("book_name:")+10,line.find(", book_author")-25);
        ...
        while ( getline (ifile2, line) ) //go through each line
        {
            if (line.length() != 0) {
                ...
                if (line.substr(0,line.find(" ")) == "add") {
                    ...
                    string arg22 = line.substr(line.find("book_name:")+10,line.find(", book_author")-35);
                    string arg32 = line.substr(line.find("book_author:")+12);
                    int arg02 = stoi(line.substr(line.find("pos:")+4,line.find("book_name:")+10));

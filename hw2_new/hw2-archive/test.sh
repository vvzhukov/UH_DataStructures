...
diff -iEBwu ans25.txt output25.txt > 3.diff
if [ $? -ne 0 ]; then
...
diff -iEBwu ans26.txt output26.txt > 3.diff
if [ $? -ne 0 ]; then
...
diff -iEBwu ans27.txt output27.txt > 3.diff
if [ $? -ne 0 ]; then
...
diff -iEBwu ans28.txt output28.txt > 3.diff
if [ $? -ne 0 ]; then
...
diff -iEBwu ans29.txt output29.txt > 3.diff
if [ $? -ne 0 ]; then
